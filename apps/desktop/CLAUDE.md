...
3. Distribute DMGs manually (GitHub release, etc.)

> **Note:** Auto-update (electron-updater / CDN manifests) has been removed. Users update by downloading and installing new DMGs manually.
