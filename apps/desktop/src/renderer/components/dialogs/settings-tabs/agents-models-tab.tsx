...
export function AgentsModelsTab() {
  ...
  const hasLocalCodexSubscription = codexOnboardingCompleted && codexOnboardingAuthMethod === 'chatgpt';
  const isCodexSubscriptionConnected =
    codexIntegration?.state === 'connected_chatgpt' || (!codexIntegration && hasLocalCodexSubscription);
                ...
                <div className="flex items-center gap-2">
                  ...
                  {isCodexSubscriptionConnected ? (
                    ...
                    <Button
                      ...
                      disabled={isCodexLoading || codexLogoutMutation.isPending || isSavingCodexApiKey}>
                      Connect
                    </Button>
                  )}
                </div>
          ...
          <div className="bg-background rounded-lg border border-border overflow-hidden">
            <div className="flex items-center justify-between gap-6 p-4">
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">Required for voice transcription (Whisper API)</p>
              </div>
            ...
            <div className="bg-background rounded-lg border border-border overflow-hidden">
              <div className="flex items-center justify-between p-4">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">Model identifier to use for requests</p>
                </div>
                <div className="flex-shrink-0 w-80">
                  <Input
                    value={model}
