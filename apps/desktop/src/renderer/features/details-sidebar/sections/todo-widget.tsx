...
const TodoListItem = ({ todo, isLast }: { todo: TodoItem; isLast: boolean }) => {
  return (
    <div className={cn('flex items-center gap-2 px-2 py-1.5', !isLast && 'border-b border-border/30')}>
    ...
    <div className="mx-2 mb-2">
      ...
      <div
        ...
        <div className="flex items-center gap-2 flex-1 min-w-0">
          ...
          <span className="text-xs text-muted-foreground truncate flex-1">{todos[0]?.content || 'To-do list'}</span>
          ...
          <div
            ...
            <div className="flex items-center gap-1.5 min-w-0 flex-1">
              ...
              {!currentTask && completedCount === totalTodos && totalTodos > 0 && (
                <span className="text-xs text-muted-foreground truncate">{todos[totalTodos - 1]?.content}</span>
              )}
            </div>
