...
function makeMinimalConfig(subChatId: string) {
  ...
  return {
    ...
    transportFactoryConfig: {
      ...
      setLoadingSubChats: vi.fn() as unknown as React.Dispatch<
        React.SetStateAction<Set<string>>
      >,
      setSubChatUnseenChanges: vi.fn() as unknown as React.Dispatch<
        React.SetStateAction<Set<string>>
      >,
      setUnseenChanges: vi.fn() as unknown as React.Dispatch<
        React.SetStateAction<Set<string>>
      >,
