...
import type { WorkflowActionKind, WorkflowState } from '../utils/workflow-state';
...
export const SubChatStatusCard = memo(function SubChatStatusCard({
  ...
  const actionLabel = nextStep ? ACTION_BUTTON_LABELS[nextStep.actionKind] : null;
              ...
              {uncommittedFiles.map((file) => {
                ...
                return (
                  <div
                    ...
                    {FileIcon && <FileIcon className="w-4 h-4 flex-shrink-0 text-muted-foreground" />}
