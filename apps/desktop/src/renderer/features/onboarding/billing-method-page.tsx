...
export function BillingMethodPage() {
  ...
  const handleContinue = () => {
    if (selectedOption.method === 'codex-subscription' || selectedOption.method === 'codex-api-key') {
    ...
    <div className="h-screen w-screen flex flex-col items-center justify-center bg-background select-none">
      ...
      <div className="w-full max-w-[440px] min-h-[520px] space-y-8 px-4">
        ...
        <div className="text-center space-y-1">
          ...
          <p className="text-sm text-muted-foreground">Choose how you'd like to connect your provider.</p>
        </div>
          ...
          {visibleOptions.map((option) => (
            <button
              ...
              className={cn(
                ...
                'active:scale-[0.99]',
                selectedOptionId === option.id ? 'bg-primary/5' : 'bg-background'
              )}>
